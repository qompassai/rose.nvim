...
M.table_to_file = function(tbl, file_path)
    ...
    -- Try to encode the table to JSON
    ...
    local write_ok, write_err = pcall(function() file:write(json_str) end)
...
-- tries to find an .rose.md file in the root of current git repo
---@return string # returns instructions from the .rose.md file
